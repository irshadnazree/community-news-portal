...
<div class="mb-8 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
    <div>
        <h1 class="text-4xl lg:text-5xl font-bold mb-2">Categories</h1>
        <p class="text-base-content/70">Manage news categories</p>
    </div>
                ...
                <tbody>
                    @forelse($categories as $category)
                        <tr class="hover">
                            ...
                            <td>
                                <span class="text-sm text-base-content/70">{{ Str::limit($category->description, 50) }}</span>
                            </td>
                            <td>
