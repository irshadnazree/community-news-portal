...
<body class="min-h-screen bg-base-100 flex flex-col">
    ...
    <div class="navbar bg-base-100/95 backdrop-blur-md shadow-lg border-b border-base-300 sticky top-0 z-50">
        <div class="container mx-auto px-4">
            <!-- Logo/Brand -->
            <div class="flex-1">
                <a href="{{ route('home') }}" class="btn btn-ghost text-xl font-bold gap-2 px-2 hover:bg-primary/10 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
                    </svg>
                    <span class="hidden sm:inline">Community News</span>
                    <span class="sm:hidden">News</span>
                </a>
            </div>
            
            <!-- Desktop Navigation -->
            <div class="hidden lg:flex flex-none items-center gap-1">
                <!-- Main Navigation -->
                <div class="flex items-center gap-1 px-2">
                    ...
                    @auth
                        <a href="{{ route('dashboard') }}" class="btn btn-ghost btn-sm gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        @if(auth()->user()->hasRole('user') || auth()->user()->isEditor())
                            <a href="{{ route('my-submissions') }}" class="btn btn-ghost btn-sm gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="flex items-center gap-2">
                    @auth
                        @if(auth()->user()->hasRole('user') || auth()->user()->isEditor())
                            <a href="{{ route('submit-news') }}" class="btn btn-primary btn-sm gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="dropdown dropdown-end">
                            ...
                            <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-56 p-2 shadow-xl border border-base-300 mt-2">
                                <li class="menu-title">
                                    ...
                                    <span class="badge badge-sm badge-{{ auth()->user()->role === 'admin' ? 'error' : (auth()->user()->role === 'editor' ? 'warning' : 'info') }}">
                                ...
                                <li>
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button type="submit" class="w-full text-left gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
